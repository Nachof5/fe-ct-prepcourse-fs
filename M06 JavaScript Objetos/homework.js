...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   for(numeroMisterioso in objetoMisterioso){
...
function verificarPassword(objetoUsuario, password) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   // let password = "Me encanta JS"
   if("password" in objetoUsuario && objetoUsuario.password === password){
      return true
   }else{
      return false
   }
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // Retornar el objeto.
   // Tu código:
   if("amigos" in objetoUsuario && typeof Array.isArray(objetoUsuario.amigos)){
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function(){
      ...
      let precioFinal = objetoProducto.precio - precioDescuento;
      return precioFinal
   }
