...
function incrementarPorUno(array) {
   ...
   // Tu código:
   let arr2 = array.map(num => {return num +1});
   return arr2
}
incrementarPorUno([2,3])
...
arrayContiene(["Hola", "mundo", "desde", "JavaScript"], "Python"); 
